...
{	
	public BlockFlamonorPortal()
	{
		...
		this.setRegistryName(Util.MOD_ID + ":" + "flamonorPortal");
	}
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
		if ((entityIn.getRidingEntity() == null) && ((entityIn instanceof EntityPlayerMP)))
		{
			...
			{
				player.timeUntilPortal = 300;
				player.mcServer.getPlayerList().transferPlayerToDimension(player, Config.flamonorID, new TeleporterFlamonor(player.mcServer.getWorld(Config.flamonorID)));
			}
			else
			{
				player.timeUntilPortal = 300;
				player.mcServer.getPlayerList().transferPlayerToDimension(player, 0, new TeleporterFlamonor(player.mcServer.getWorld(0)));
			}
